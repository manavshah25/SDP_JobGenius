                      ...
                      <div class="col-sm-9">
                        <FormControl required fullWidth sx={{ m: 1 }} variant="standard">
                          ...
                          <Input
                            ...
                            type="number" inputProps={{ inputMode: 'numeric', pattern: '[0-9]*' }} name="salary" value={Data.salary} onChange={handlechange} startAdornment={<InputAdornment position="start">$</InputAdornment>}
                          />
                        </FormControl>
                      </div>
                    </div>
              ...
              <div class="col-md-3">
                <div class="section quick-rules">
                  ...
                  <ul class="tr-list">
                    ...
                    <li>
                      Make sure that all the Job Functions values should be given in rating from 1-5.
                      If you don't know the skills marks rating as 1 in that skill.
                    </li>
                  </ul>
                </div>
              </div>
