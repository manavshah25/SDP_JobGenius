            ...
            <ul class="job-meta tr-list list-inline">
              ...
              <li>
                ...
                <a href="#">
                  <span
                    class="__cf_email__"
                    data-cfemail="dcb6b4b3b2b8b3b99cbbb1bdb5b0f2bfb3b1"
                  >
                    [email&#160;protected]
                  </span>
                </a>
              ...
              <li>
                <i class="fa fa-briefcase" aria-hidden="true"></i>UI & UX
                Designer
              </li>
            </ul>
          ...
          <div class="row">
            <div class="col-md-4 col-lg-3">
              <div class="tr-sidebar">
                ...
                <a href="#" class="btn btn-primary">
                  ...
                  <span>Download Resume as doc</span>
                </a>
              </div>
            </div>
            <div class="col-md-8 col-lg-9">
              <div class="tab-content">
                ...
                >
                  ...
                  <div class="section display-information">
                    ...
                    <ul class="tr-list account-details">
                      <li>
                        Display Name<span>Jhon Doe</span>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <span>
                          <a href="#">
                            <span
                              class="__cf_email__"
                              data-cfemail="2e444641404a414b6e49434f4742004d4143"
                            >
                              [email&#160;protected]
                            </span>
                          </a>
                      ...
                      <li>
                        Industry Expertise<span>UI & UX Designer</span>
                      </li>
                    </ul>
                  </div>
                  <div class="section">
                    ...
                    <ul class="social social-icon-bg tr-list">
                      <li>
                        ...
                        <span class="media-body">
                          <a href="#">https://www.facebook.com/jhondoe</a>
                        </span>
                      </li>
                      <li>
                        <i class="fa fa-twitter"></i>
                        <span class="media-body">
                          <a href="#">https://www.twitter.com/jhondoe</a>
                        </span>
                      </li>
                      <li>
                        <i class="fa fa-google-plus"></i>
                        <span class="media-body">
                          <a href="#">https://www.googleplus.com/jhondoe</a>
                        </span>
                      </li>
                      <li>
                        <i class="fa fa-linkedin"></i>
                        <span class="media-body">
                          <a href="#">https://www.linkedin.com/jhondoe</a>
                        </span>
                      </li>
                      <li>
                        <i class="fa fa-dribbble"></i>
                        <span class="media-body">
                          <a href="#">https://www.dribbble.com/jhondoe</a>
                        </span>
                      </li>
                      <li>
                        <i class="fa fa-behance"></i>
                        <span class="media-body">
                          <a href="#">https://www.behance.com/jhondoe</a>
                        </span>
                      </li>
                      <li>
                        <i class="fa fa-globe"></i>
                        <span class="media-body">
                          <a href="#">https://www.globe.com/jhondoe</a>
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <ul class="tr-list resume-info">
                    ...
                    <li class="work-history media">
                      ...
                      <div class="media-body">
                        ...
                        <ul class="tr-list">
                          ...
                          <li>
                            <span>
                              Graphic Designer (Intern) @ Costa Rica Fruit
                              Compnay
                            </span>
                    ...
                    <li class="qualification media">
                      ...
                      <div class="media-body">
                        ...
                        <ol>
                          <li>
                            5 years+ experience designing and building products
                            In the Design & IT industry.
                          </li>
                          <li>
                            Passion for people-centered design, solid intuition.
                          </li>
                      ...
                      <div class="media-body">
                        ...
                        <ul class="tr-list">
                          <li>
                            ...
                            <span class="right">Jhon Doe</span>
                          </li>
                          <li>
                            <span class="left">Father's Name </span>
                            <span class="middle">:</span>
                            <span class="right">Robert Doe</span>
                          </li>
                          <li>
                            <span class="left">Mother's Name</span>
                            <span class="middle">:</span>
                            <span class="right">Ismatic Roderos Doe</span>
                          </li>
                          <li>
                            <span class="left">Date of Birth</span>
                            <span class="middle">:</span>
                            <span class="right">26/01/1982</span>
                          </li>
                          <li>
                            <span class="left">Birth Place</span>
                            <span class="middle">:</span>
                            <span class="right">United State of America</span>
                          </li>
                          <li>
                            <span class="left">Nationality</span>
                            <span class="middle">:</span>
                            <span class="right">Canadian</span>
                          </li>
                          <li>
                ...
                <div
                  role="tabpanel"
                  class="tab-pane edit-resume section"
                  id="edit-resume"
                >
                  <ul class="tr-list resume-info">
                    ...
                    <li class="work-history">
                      ...
                      <div class="media-body additem-work">
                        ...
                        <div id="addhistory" class="additem">
                          <span id="clone" class="icon clone">
                    ...
                    <li class="education-background">
                      ...
                      <div class="media-body additem-edu">
                        ...
                        <div id="add-edu" class="additem">
                          <span id="edu-clone" class="icon clone">
                            <i class="fa fa-plus" aria-hidden="true"></i>
                          </span>
                          <span class="icon remove">
                            <i class="fa fa-times" aria-hidden="true"></i>
                          ...
                          <div class="code-edit-small">
                            <label>Degree</label>
                            <div class="code-edit">
                              <span>Diploma in Graphic Designer</span>
                            </div>
                            <label>Institute Name</label>
                            <div class="code-edit">
                              <span>Cincinnati Christian University</span>
                            </div>
                            <div class="row">
                              <div class="col-sm-6 col-md-4">
                    ...
                    <li class="qualification">
                      ...
                      <div class="media-body">
                        ...
                        <div class="code-edit">
                          <ol>
                            <li>
                              5 years+ experience designing and building
                      ...
                      <div class="media-body">
                        ...
                        <div class="rating-star">
                          ...
                          <div class="rating">
                            ...
                            <input type="radio" id="star12" name="rating1" />
                            <label class="half" for="star12"></label>
                            <input type="radio" id="star13" name="rating1" />
                            <label class="full" for="star13"></label>
                            <input type="radio" id="star14" name="rating1" />
                            <label class="half" for="star14"></label>
                            <input type="radio" id="star15" name="rating1" />
                            <label class="full" for="star15"></label>
                            <input type="radio" id="star16" name="rating1" />
                            <label class="half" for="star16"></label>
                            <input type="radio" id="star17" name="rating1" />
                            <label class="full" for="star17"></label>
                            <input type="radio" id="star18" name="rating1" />
                            <label class="half" for="star18"></label>
                            <input type="radio" id="star19" name="rating1" />
                            <label class="full" for="star19"></label>
                            <input type="radio" id="star20" name="rating1" />
                            <label class="half" for="star20"></label>
                          </div>
                        </div>
                        <div class="rating-star">
                          <span class="pull-left code-edit">Spanish</span>
                          <div class="rating">
                            <input type="radio" id="star21" name="rating2" />
                            <label class="full" for="star21"></label>
                            <input type="radio" id="star22" name="rating2" />
                            <label class="half" for="star22"></label>
                            <input type="radio" id="star23" name="rating2" />
                            <label class="full" for="star23"></label>
                            <input type="radio" id="star24" name="rating2" />
                            <label class="half" for="star24"></label>
                            <input type="radio" id="star25" name="rating2" />
                            <label class="full" for="star25"></label>
                            <input type="radio" id="star26" name="rating2" />
                            <label class="half" for="star26"></label>
                            <input type="radio" id="star27" name="rating2" />
                            <label class="full" for="star27"></label>
                            <input type="radio" id="star28" name="rating2" />
                            <label class="half" for="star28"></label>
                            <input type="radio" id="star29" name="rating2" />
                            <label class="full" for="star29"></label>
                            <input type="radio" id="star30" name="rating2" />
                            <label class="half" for="star30"></label>
                          </div>
                        </div>
                        <div class="rating-star">
                          <span class="pull-left code-edit">Latin</span>
                          <div class="rating">
                            <input type="radio" id="star31" name="rating3" />
                            <label class="full" for="star31"></label>
                            <input type="radio" id="star32" name="rating3" />
                            <label class="half" for="star32"></label>
                            <input type="radio" id="star33" name="rating3" />
                            <label class="full" for="star33"></label>
                            <input type="radio" id="star34" name="rating3" />
                            <label class="half" for="star34"></label>
                            <input type="radio" id="star35" name="rating3" />
                            <label class="full" for="star35"></label>
                            <input type="radio" id="star36" name="rating3" />
                            <label class="half" for="star36"></label>
                            <input type="radio" id="star37" name="rating3" />
                            <label class="full" for="star37"></label>
                            <input type="radio" id="star38" name="rating3" />
                            <label class="half" for="star38"></label>
                            <input type="radio" id="star39" name="rating3" />
                            <label class="full" for="star39"></label>
                            <input type="radio" id="star40" name="rating3" />
                            <label class="half" for="star40"></label>
                          </div>
                        </div>
                      </div>
                    </li>
                    <li class="personal-deatils code-edit-small">
                      ...
                      <div class="media-body">
                        ...
                        <div class="row">
                          <div class="col-sm-4">
                            <label>
                              Full Name<span class="pull-right">:</span>
                            </label>
                          </div>
                          <div class="col-sm-8">
                        ...
                        <div class="row">
                          <div class="col-sm-4">
                            <label>
                              Father's Name<span class="pull-right">:</span>
                            </label>
                          </div>
                          <div class="col-sm-8">
                        ...
                        <div class="row">
                          <div class="col-sm-4">
                            <label>
                              Birth Place<span class="pull-right">:</span>
                            </label>
                          </div>
                          <div class="col-sm-8">
                        ...
                        <div class="row">
                          <div class="col-sm-4">
                            <label>
                              Nationality<span class="pull-right">:</span>
                            </label>
                          </div>
                          <div class="col-sm-8">
                        ...
                        <div class="row">
                          <div class="col-sm-4">
                            <label>
                              Sex<span class="pull-right">:</span>{" "}
                            </label>
                          </div>
                          <div class="col-sm-8">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 remove-item">
                      <div class="job-item">
                        ...
                        <div class="item-overlay">
                          <div class="job-info">
                            <a href="job-details.html" class="btn btn-primary">
                              Part Time
                            </a>
                            <span class="tr-title">
                ...
                <div
                  role="tabpanel"
                  class="tab-pane section close-account"
                  id="close-account"
                >
